...
## IP Info
set Vendor      "kamiyaowl"
set Library     "hls"
set IPName      "pynq_dsp_hls"
set Version     "0.2"
set DisplayName "PYNQ DSP HLS"
set Revision    "2002082016"
set Description "Audio DSP"
set Device      "zynq"
set AutoFamily  ""
...
set sdx_kernel_name "pynq_dsp_hls"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "C:/Users/user/repos/pynq_dsp_hls/pynq_dsp_hls/pynq_dsp_hls"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {pynq_dsp_hls_fmulbkb
...
## Variables
set Top "pynq_dsp_hls"
set TopNoPrefix "pynq_dsp_hls"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_physMemPtr_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_physMemPtr_V {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_physMemPtr_V"
        data_width "32"
        param_prefix "C_M_AXI_PHYSMEMPTR_V"
...
## System Info
set user_parameters_list {clk_period 8 machine 64 combinational 0 latency 10 II x}
